...
jest.mock('@/shared/config/env', () => ({
  env: {
    ...
    FOUNDRY_OUT_DIR: process.env.FOUNDRY_OUT_DIR || '../zuno-marketplace-contracts/out',
    FOUNDRY_BROADCAST_DIR: process.env.FOUNDRY_BROADCAST_DIR || '../zuno-marketplace-contracts/broadcast',
  },
}))

// Mock nanoid to avoid ESM issues
jest.mock('nanoid', () => ({
  nanoid: jest.fn(() => 'mock_nano_id_123456'),
}))
